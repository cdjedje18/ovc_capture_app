...
const MembersFormPageBodyPlain = ({
    programId,
    orgUnitId,
    trackedEntityTypeId,
...
const MembersFormPageBodyWithStyles = withStyles(styles)(MembersFormPageBodyPlain);
const MembersFormPageBodyWithError = withErrorMessageHandler()(MembersFormPageBodyWithStyles);
export const MembersFormPageBody = withLoadingIndicator()(MembersFormPageBodyWithError) as ComponentType<ContainerProps>;
